...
class Scripts {
	...
	public function __construct() {
		...
		if ( $pagenow === 'site-editor.php' ) {
			add_action( 'admin_init', array( $this, 'block_editor_assets' ), 1 );
			add_action( 'admin_init', array( $this, 'frontend_backend_assets' ) );
		}

		add_action( 'enqueue_block_editor_assets', array( $this, 'block_editor_assets' ) );
		add_action( 'enqueue_block_editor_assets', array( $this, 'frontend_backend_assets' ) );
		add_action( 'wp_enqueue_scripts', array( $this, 'frontend_backend_assets' ) );
