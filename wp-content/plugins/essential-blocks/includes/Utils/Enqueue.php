...
class Enqueue {
	...
	public function enqueue( $handle, $filename, $dependencies = array(), $args = null ) {
	 ...
	 * @return void
	 */
	public function register( $handle, $filename, $dependencies = array(), $args = null ) {
		$handle = $this->handle( $handle );
		$config = $this->asset_config( $filename, $dependencies, $args );
	...
	public function asset_config( $filename, $dependencies = array(), $args = null ) {
